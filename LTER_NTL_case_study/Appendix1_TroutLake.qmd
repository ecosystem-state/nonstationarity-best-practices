...
Here we show the LM, and GAM  analysis for the Trout Lake dataset. For complete code, see the [full quarto document](https://github.com/ecosystem-state/nonstationarity-best-practices/blob/main/GOA_salmon_case_study/Appendix3_GoASalmon.qmd)
...
full_data <- readRDS(here::here("LTER_NTL_case_study/NTL_LTER_TL_data.rds"))
