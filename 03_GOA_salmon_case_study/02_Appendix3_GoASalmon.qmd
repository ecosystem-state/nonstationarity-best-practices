...
resid_df1 <- data.frame(resid = pred$y - pred$estimate,
                       date = dat_aksalmon$date,
                       Model = "Intercept + slope")
resid_df2 <- data.frame(resid = pred2$y - pred2$estimate,
                       date = dat_aksalmon$date,
                       Model = "Slope")
...
Time series of residuals from the GAM model fit with a time-varying slope and both a time-varying slope and intercept.
:::
...
Time series of residuals from the DLM model fit with a time-varying slope and both a time-varying slope and intercept.
:::
